...
import {BreakingNews, useBreakingNewsHook,} from "components/ui-own/breaking-news";
...
const BreakingNewsComp: React.FC<any> = ({
  querySearch,
}) => {
  const { t } = useTranslation();
  const api = useCallback(
    () => apiGetBreakingNews({ search_term: querySearch }),
    [querySearch]
  );
